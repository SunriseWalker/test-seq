package com.io.test.client.stream;
...
public class StreamTest {
    ...
    public static void main2(String[] args) {
       // 案例一：筛选出Integer集合中大于 7 的元素，并打印出来
        ...
        //案例二：筛选员工中工资高于 8000 的人，并形成新的集合。 形成新集合依赖collect（收集）
    ...
    public static void main9(String[] args) {
        ...
        personList.add(new Person("Jack", 7000, 7,"male", "Washington"));
        personList.add(new Person("Lily", 7800, 6,"female", "Washington"));
        personList.add(new Person("Anni", 8200, 8,"female", "New York"));
        personList.add(new Person("Owen", 9500, 3,"male", "New York"));
